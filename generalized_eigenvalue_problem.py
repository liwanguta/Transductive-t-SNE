"""
The following class is an implementationf for solving the generalized eigenvalue problem. 
The code is taken from the following GitHub webpage.
    https://github.com/bghojogh/Generalized-Eigenvalue-Problem
"""
...
class generalized_eigenvalue_problem:
